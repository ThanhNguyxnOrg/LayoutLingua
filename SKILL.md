---
name: layout-lingua
description: Translate local, text-based PDFs into any supported language while preserving the original layout, formulas, tables, and figures. Use for PDF translation, batch translation, terminology-sensitive handoff translation, or diagnosing incomplete translated output.
