...
heuristics where the desktop build uses doclayout-yolo/YOLOv8, reads text-based PDFs
...
it and `app/update.py` downloads `LayoutLingua-windows.zip` from whatever the
