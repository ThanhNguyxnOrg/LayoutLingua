...
import org.thanhnguyxn.layoutlingua.BuildConfig
...
class UpdateChecker(private val currentVersion: String = BuildConfig.VERSION_NAME) {
    ...
    private val releasesUrl = "https://api.github.com/repos/ThanhNguyxnOrg/LayoutLingua/releases?per_page=30"
    ...
    suspend fun checkForUpdate(): UpdateInfo? = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
                ...
                .header("User-Agent", "LayoutLingua-Android/$currentVersion")
                .build()
    ...
    companion object {
        ...
        private const val FALLBACK_RELEASES_URL =
            "https://github.com/ThanhNguyxnOrg/LayoutLingua/releases"
